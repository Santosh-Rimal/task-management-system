                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/80 transition-colors duration-150">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex flex-wrap gap-2">
                            <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900/50 dark:text-indigo-200 shadow-sm"> {{ $role->name ?? '' }}
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
...
=======
                        <x-customecomponent.actionbutton id="{{ $role->id }}" variant="primary" color="amber-500 hover:amber-600"
                            button="Edit" action="edit" />

                        <x-customecomponent.actionbutton id="{{ $role->id }}" variant="primary" color="emerald-500 hover:emerald-600"
                            button="Show" action="show" />

                        <x-customecomponent.actionbutton id="{{ $role->id }}" variant="primary" color="rose-500 hover:rose-600"

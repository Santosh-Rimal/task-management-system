            ...
            @forelse ($users as $user)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/80 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                        <x-customecomponent.actionbutton id="{{ $user->id }}" variant="primary" color="yellow"
                            button="Edit" action="edit" />

                        <x-customecomponent.actionbutton id="{{ $user->id }}" variant="primary" color="green"
                            button="Show" action="show" />

                        <x-customecomponent.actionbutton id="{{ $user->id }}" variant="primary" color="rose"

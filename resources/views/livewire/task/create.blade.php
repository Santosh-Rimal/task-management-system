<flux:modal class="md:w-96" name="create-task">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">Create Task</flux:heading>
            <flux:text class="mt-2">You can create a task from here.</flux:text>
        </div>
        ...
        <div class="flex">
            <flux:spacer />
            <flux:button type="submit" variant="primary" wire:click="savetask">Save Task</flux:button>
        </div>
    </div>
</flux:modal>
